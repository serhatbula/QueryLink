 ...
 * This file demonstrates how to integrate Querylink with a web frontend
 */

// For React/Vue/Angular applications
export class QuerylinkClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuerylinkClient(provider, contractAddress);
